...
<body>
  ...
  <div class="row" style="--bs-gutter-x: 0rem;">
      ...
      <a href="" class="finders " style="text-decoration: none;  color:black; margin-right:50px;">Artikelen  </a><a href="" class="finders" style="text-decoration: none; color:grey ;">Zoekertjes</a>
