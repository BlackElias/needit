...
<body>
    <div class="row" style="--bs-gutter-x: 0rem;" >
        <div class="bg-image p-3 text-center shadow-1-strong col-md   flex-item-left" style="
         background-repeat: no-repeat; margin-top: 10px; ">
            ...
            <p>Hallo! wij zijn 2 studenten van Thomas more met een idee</p>
    ...
    <div class="col-md " style=" ">
         ...
         <div class="float-start">
           <img  src="img/pfElias.png" style="width: 15%; margin-left: 10%" alt="profilePic">
                <p >Elias valienne</p>
                <p  >Less is more</p>
                
                <img src="img/pfElias.png" style="width: 15%; margin-right: 0%" alt="profilePic">
                <p  >Elias valienne</p>
                <p  >Less is more</p>
                </div>
                </div>
